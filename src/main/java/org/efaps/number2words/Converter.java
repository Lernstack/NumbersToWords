...
public final class Converter {
    ...
    public static String translateToSpanish(long _number) {
        Locale esLocale = new Locale("es", "ES");
        String message;
        message = getMaleConverter(esLocale).convert(_number);
        return message.toUpperCase();
    }

    public static String translateToEnglish(long _number) {
        String message;
        message = getMaleConverter(Locale.ENGLISH).convert(_number);
        return message.toUpperCase();
    }

    public static void main(String[] args) {

        long message = Long.parseLong(JOptionPane.showInputDialog("Ingresa el numero a convertir"));
        System.out.println(translateToEnglish(message));
        System.out.println(translateToSpanish(message));
    }
